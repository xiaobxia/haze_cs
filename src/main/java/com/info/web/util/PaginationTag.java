...
/**
 * @author gaoyuhai 2016-6-22 下午03:40:36
 */
        ...
        try {
            ...
            switch (type) {
                ...
                case 3: // 模式3 (10页缩进) (only IE)
                    out
                            .print("<style type=\"text/css\">.p-unsele-page {font-size:12px;border:1px solid #ccc;}"
                                    + "</style>");
                    out
                            .print("<table id =\"pag\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">");
                    out.print("<tr>");
                    ...
                    if (this.page == 1) {
                        ...
                        out.print("<td width=\"20\" height=\"20\">");
                        out
                                .print("<button class=\"page_prew\" onclick=\"window.location='"
                                        + toPage(prevPage) + "'" + "\"></button>");
                        out.print("</td>");
                    }
                    if (this.page > 5 && this.page + 5 >= this.totalPage) {
                        out
                                .print("<td width=\"20\" height=\"20\" align=\"center\"  class=\"p-unsele-page\">");
                        out.print("<a class=\"user_vip_page\"  href=" + toPage(1)
                                + " title=\"第" + 1 + "页\">" + 1 + "</a>");
                        out.print("</td>");
                        out
                                .print("<td width=\"20\" height=\"20\" align=\"center\"  class=\"p-unsele-page\">");
                        ...
                        if (this.page - 5 >= 1) {
                            for (int i = this.page - 5; i <= this.totalPage; i++) {
                                out
                                        .print("<td width=\"20\" height=\"20\" align=\"center\" class=\"p-unsele-page\">");
                                if (this.page == i) {
                                    out.print("<font color=\"red\">" + i
                                            + "</font>");
                                } else {
                                    out.print("<a class=\"user_vip_page\"  href="
                                            + toPage(i) + "" + " title=\"第" + i
                                            + "页\">" + i + "</a>");
                                }
                                out.print("</td>");
                                ...
                                if (this.page - 5 >= 1) {
                                    for (int i = this.page - 5; i <= this.page + 10; i++) {
                                        ...
                                        if (i == this.page) {
                                            ...
                                            out
                                                    .print("<a class=\"user_vip_page\" href="
                                                            + toPage(i)
                                                            + ""
                                                            + " title=\"第"
                                                            + i
                        ...
                        if (this.page - 5 >= 3) {
                            ...
                            for (int i = this.page - 5; i <= this.page + 5; i++) {
                                out
                                        .print("<td width=\"20\" class=\"p-unsele-page\" height=\"20\" align=\"center\" >");
                                if (this.page == i) {
                                    out.print("<font color=\"red\">" + i
                                            + "</font>");
                                } else {
                                    out.print("<a class=\"user_vip_page\" href="
                                            + toPage(i) + " title=\"第" + i + "页\">"
                                            + i + "</a>");
                                }
                                out.print("</td>");
                    ...
                    if (this.page != this.totalPage) {
                        out.print("<td width=\"20\" height=\"20\">");
                        out
                                .print("<button class=\"page_next\" onclick=\"window.location='"
                                        + toPage(nextPage) + "" + "'\"></button>");
                        out.print("</td>");
                        out.print("<td width=\"40\" height=\"20\">到第</td>");
                        out
                                .print("<td width=\"20\" height=\"20\"><input id=\"page\" name=\"textfield2\" type=\"text\" class=\"writein_field\" size=\"2\" /></td>");
                        out.print("<td width=\"20\" height=\"20\">页</td>");
                        out
                                .print(" <td  height=\"20\"><button class=\"page_fir\" align=\"left\" onclick=\"toPage('"
                        ...
                        out.print("<td width=\"20\" height=\"20\">页</td>");
                        out
                                .print(" <td  height=\"20\" align=\"left\"><button class=\"page_fir\" onclick=\"toPage('"
                                        + this.action + "')\"></button></td>");
                ...
                case 9: // 模式2 (前后缩略,页数,首页,前页,后页,尾页)
                    ...
                    if (prevPage < 1) {
                        ...
                        out.print("<span id=\"pages\"  title='到第一页'><a href='"
                                + this.toPage(1) + "'>首页</a></span>");

                        out.print("<span id=\"pages\" title='上一页'><a href='"
                                + this.toPage(prevPage) + " ');'>上一页</a></span>");
                    }
                    if (this.page != 1) {
                        out.print("<span id=\"test\" title='到第一页'><a href='"
                                + this.toPage(1) + "'>1</a></span>");
                    }
                    ...
                    for (int i = this.page - 2; i <= endPage1; i++) {
                        if (i > 0) {
                            if (i == this.page) {
                                ...
                                out.print("<span id=\"currentPage\" title='第 " + i
                                        + "页'>" + i + "</span>");
                            } else {
                                if (i != 1 && i != this.totalPage) {
                ...
                case 10:
                    ...
                    if (prevPage < 1) {
                        out
                                .print("<a href=\"#\" title=\"上一页\" class=\"PrevPage\" >上一页</a>");
                    } else {
                    ...
                    for (int i = this.page - 5; i <= endPage2; i++) {
                        if (i > 0) {
                            if (i == this.page) {
                                ...
                                out.print("<span class=\"PageSel\">" + i
                                        + "</span>");
                            } else {
                                if (i != 1 && i != this.totalPage) {
                                    out.print("<a href=\"" + this.toPage(i)
                    ...
                    if (this.page != this.totalPage) {
                        out.print("<a  href='" + this.toPage(this.totalPage)
                                ...
                                + this.totalPage + "'>" + this.totalPage + "</a>");
                    }

                    if (nextPage > this.totalPage) {
                        out
                                .print("<a href=\"#\" title=\"下一页\" class=\"NextPage\" >下一页</a>");
