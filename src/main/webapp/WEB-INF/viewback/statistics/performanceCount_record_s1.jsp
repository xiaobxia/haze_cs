...
<form id="pagerForm" onsubmit="return navTabSearch(this);"
      action="performance/toPerformancePage?myId=${params.myId}&groupLevel=3" method="post">
        ...
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    ...
                    <td>派单时间：
                        <input type="text" name="begDate" id="begDate" value="${params.begDate}"
