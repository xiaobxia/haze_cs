...
<form id="pagerForm" onsubmit="return navTabSearch(this);"
      action="performance/toPerformancePage?myId=${params.myId}&groupLevel=4" method="post">
        ...
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    ...
                    <td>
                        手机号:
                        <input type="text" name="tel" id="tel_s2"
                               value="${params.tel }"/>
                    </td>

                    <td>派单时间：
                        <input type="text" name="begDate" id="begDate_s2" value="${params.begDate}"
                               class="date textInput readonly" datefmt="yyyy-MM-dd" readonly="readonly"/>
                        至 <input type="text" name="endDate" id="endDate_s2" value="${params.endDate}"
                                 class="date textInput readonly" datefmt="yyyy-MM-dd" readonly="readonly"/>
                    </td>

                    <td>
                        排序:
                        <select id="sortBy_s2" name="sortBy">
...
<script type="text/javascript">
    ...
    function reportExcel_s2(obj){
        var href=$(obj).attr("href");
        var begDate=$("#begDate_s2").val();
        var endDate=$("#endDate_s2").val();
        var tel = $("#tel_s2").val();
        var sortBy = $("#sortBy_s2").val();
        var toHref = href;
        console.log(begDate);
