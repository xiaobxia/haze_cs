...
%>
<link href="<%=path %>/common/back/themes/default/style.css"  rel="stylesheet" type="text/css"/>

<div class="pageContent">
	<table class="table" style="width: 100%;display: table;border-collapse: separate;border-spacing: 2px;border-color: grey;" layoutH="115" nowrapTD="false" border="1">
		<thead>
		<tr>
		...
		<c:forEach var="record" items="${listRecord}" varStatus="status">
			<tr target="recordId" rel="${record.id }">
				...
				<td>
						${record.repaymentDescript}
				</td>
				<td>
						${record.reductionDescript}
				</td>
			</tr>
		</c:forEach>
		</tbody>
