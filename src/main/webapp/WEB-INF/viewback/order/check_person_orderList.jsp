...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="mmanLoanCollectionOrder/getMmanLoanCollectionOrderPage?myId=${params.myId}&check_person=true" method="post">
                ...
                <tr>
                    ...
                    <td id = "status_td">
                        ...
                        <select id="status" name="status">
                            ...
                            <option value="5" <c:if test="${params.status eq '5'}">selected = "selected"</c:if>> 续期 </option>
