...
(function($) {
	if ($.validator) {
		...
		$.validator.addMethod("phone", function(value, element) {
			return this.optional(element) || /^(((1[0-9][0-9]{1}))+\d{8})$/.test(value);
		}, "Please specify a valid phone number");
		$.validator.addMethod("isTel", function(value, element) {
			return this.optional(element) || /^\d{3,4}-\d{7,9}$/.test(value)||/^[1-9]\d{6,8}$/.test(value);
		}, "Please  right telephone");
		$.validator.addMethod("isIdCardNo", function(value, element) {
			return this.optional(element) || isIdCardNo(value);
		}, "Please  right idCardNum");
		...
		$.validator.addMethod("isBl", function(value, element) {
			return this.optional(element) || /^[1-1]{1}:((0\.[1-9]{1}$)|(0\.[0-9][1-9]$)|([1-9]\d*$)|([1-9]\d*(\.[0-9]{1,2}$)))/.test(value);
		}, "Please  right bl");
...
$this.genTree({
						...
						_checkParent : function() {
							...
							var rClass = (ckboxed == ckbox ? "indeterminate"
								...
								.addClass(aClass);
							//20160701 fyc修改，这样选中子节点，父节点也会选中(不加此代码只有选中样式，而没有选中的值)
							  if (aClass == 'checked') {
...
var sortDrag={
		...
		stop : function() {
			var $helper = $(arguments[0]), $item = $helper.data('$item'), $placeholder = $helper
					.data('$placeholder');
